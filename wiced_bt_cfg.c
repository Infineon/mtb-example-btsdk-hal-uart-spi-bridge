...
#define WICED_DEVICE_NAME                       "uart spi bridge"

/*****************************************************************************
 * wiced_bt core stack configuration
 ****************************************************************************/
const wiced_bt_cfg_settings_t hci_bridge_cfg_settings =
{
    .device_name                         = (uint8_t *)WICED_DEVICE_NAME,                             // Local device name (NULL terminated)
    .device_class                        = { 0x08, 0x07, 0x04 },                                     // Local device class
 ...
 *****************************************************************************/
const wiced_bt_cfg_buf_pool_t hci_bridge_cfg_buf_pools[WICED_BT_CFG_NUM_BUF_POOLS] =
{
/*  { buf_size, buf_count } */
